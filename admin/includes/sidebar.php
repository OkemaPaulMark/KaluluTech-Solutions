<aside
  ...
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard "
      ...
      <span class="ms-1 font-weight-bold text-white">KTS Admin Dashboard </span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link text-white " href="calls.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Calls to Action</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white " href="feedbacks.php">
          ...
          <span class="nav-link-text ms-1">View Feedbacks</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link text-white " href="view_blog.php">
          <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">View Blog</span>
        </a>
      </li>
    </ul>
  </div>
